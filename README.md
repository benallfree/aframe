...
## **NOTICE** This is an experimental fork modified for Cordova compatibility ([compare fork](https://github.com/aframevr/aframe/compare/master...benallfree:master)). See [cordova-plugin-aframe](https://github.com/benallfree/cordova-plugin-aframe) for more information.</h1>
