...
<h1>**NOTICE** This is an experimental fork modified for Cordova compatibility. It ships with (cordova-plugin-aframe)[https://github.com/benallfree/cordova-plugin-aframe].</h1>
